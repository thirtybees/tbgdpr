...
# FILES+=("views/js/app/dist/checkout-${BUILD_HASH}.bundle.min.js")
# FILES+=("views/js/app/dist/ordergrid-${BUILD_HASH}.bundle.min.js")
# FILES+=("views/js/app/dist/orderpage-${BUILD_HASH}.bundle.min.js")
# FILES+=("views/js/app/dist/paperselector-${BUILD_HASH}.bundle.min.js")
